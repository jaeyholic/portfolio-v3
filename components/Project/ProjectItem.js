    ...
    <Link href={link} passHref>
      <div className='bg-gray-100 dark:bg-gray-50 dark:text-trueGray-800 rounded-lg p-4 sm:p-20 cursor-pointer my-8 sm:my-0'>
        ...
        <div className='sm:flex items-center justify-between mt-10'>
          ...
          <div>
            <Link href={link} passHref>
              <a className='flex items-center justify-center bg-trueGray-800 py-3 sm:py-4 w-48 text-white font-semibold focus:outline-none rounded-md focus:ring-2 focus:ring-offset-white focus:ring-trueGray-800 focus:ring-offset-4 hover:transform hover:scale-50 hover:shadow-lg transition duration-200 ease-out'>
                View more
                <svg
