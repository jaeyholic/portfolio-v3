      ...
      <div class='relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2'>
        <div class='lg:col-start-2 lg:pl-8'>
          <div class='text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0'>
            <p class='leading-6 text-green-600 font-semibold tracking-wide uppercase'>
              Work with us
            </p>
            <h1 class='mt-2 mb-8 text-3xl leading-8 font-extrabold tracking-tight  sm:text-4xl sm:leading-10'>
              Our Process
            </h1>
            ...
            <div class='prose dark:text-gray-400 text-gray-700'>
              <p>
